                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-slate-500">
                                    Coste: <span className="font-medium text-slate-700">{product.monthlyCost}€/mes</span>
                                    {' • '}
                                    Bonificación: <span className="font-medium text-green-600">-{product.interestReduction}%</span>
                                </p>
                            </div>
                        </div>
